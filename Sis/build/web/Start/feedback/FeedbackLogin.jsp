        ...
        <div id="wrap">
            ...
            <div id="maincontent">
                ...
                <div id="feedform" align="center">
                    <html:form action="/Feedlog" onsubmit="return ValidateContactForm()" >
                        ...
                        <table align="center"> 
                            <tr>
                                <td align="right" > <font size="5" style="color:wheat">REGD NO:</font></td>
                                ...
                                <td><font size="5" style="color:wheat">PASSWORD:</font></td>
