...
<html>
    ...
    <body id="wrap" background="<%=contextPath%>/Start/Depart/cse/aftlgnbg.jpg" >
       <%
        ...
        <div class="menu4">
            <a href="rhome.pvk" ><span>Second Sem Home</span></a>
         
            <a href="secondsdaer.pvk" ><span>Attendence Entry</span></a>
            <a href="secondsdmer.pvk" ><span>Mid Marks Entry</span></a>
            <a href="secondsdsmer.pvk"><span>Sem Marks Entry</span></a>
            <a href="secondgradesr.pvk" class="current"><span>Grades</span></a>
        ...
        <br>
        <div  id="maincontent">  
            <html:form action="secondgradesr">
