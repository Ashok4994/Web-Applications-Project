...
<html>
    ...
    <body id="wrap" background="<%=contextPath%>/Start/Depart/cse/aftlgnbg.jpg" >
        ...
        <div class="menu4">
            <a href="rhome.pvk" ><span>Fourth Sem Home</span></a>
          
            <a href="fourthsdaer.pvk" ><span>Attendence Entry</span></a>
            <a href="fourthsdmer.pvk" ><span>Mid Marks Entry</span></a>
            <a href="fourthsdsmer.pvk"><span>Sem Marks Entry</span></a>
            <a href="fourthgradesr.pvk" class="current"><span>Grades</span></a>
        ...
        <br>
        <div  id="maincontent">  
            <html:form action="fourthgradesr">
