...
<html>
    <head>
        ...
        <title>Examination Cell Login</title>
        ...
        <div id="content">
            <div id="scrollContent">
                <center><img SRC="<%=contextPath%>/Start/Depart/cse/headlogo.jpg" alt="login logo" height="80" width="500" /><br> <br> 
                    <form action="loginr.pvk" method="post" name="LoginForm" onsubmit="return ValidateContactForm()"  >
                        <table width="50%" align="center" >
                            <tr>
                            <font color="red" size="4"><%
                                Object rerr = request.getAttribute("rerr");
                                if (rerr == null) {
                                } else {
                                    out.print(request.getAttribute("rerr"));
                                }
                            %></font>
                        </tr><tr></tr><tr></tr>
                    <tr >
