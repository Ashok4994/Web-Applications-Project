...
<html>
    <head>   <link rel="stylesheet" type="text/css" href="<%=contextPath%>/Start/Css/Home/Home.css" title="Home" media="screen,projection" />
        ...
        <script language="javascript" type="text/javascript">
            ...
            function ValidateContactForm()
            {
                ...
                if (op.value == "Enter Old Password Here" || op.value == "")
                {
                    alert("Please Enter Old Password!!!");
                    op.focus();
                    return false;
                } else if (np.value == "Enter New Password Here" || np.value == "")
                {
                    alert("Please Enter New Password!!!");
                    np.focus();
                    return false;
                } else if (rnp.value == "Re-Enter New Password Here" || rnp.value == "")
                {
    ...
    <body id="back">
        ...
        %>
        <div id="wrap">
            <h1><img src="<%=contextPath%>/Start/Images/Home/1.jpg" width="35"/>&nbsp<a  href="https://lbrce.ac.in//" target="_blank">Lakireddy Balireddy College Of Engineering</a></h1>
            ...
            <nav>
                <div id="menubar">
                    <ul id="nav" >
                        ...
                        <li  class="current"><a href="scp.pvk">Change Password</a></li>
            ...
            <div id="maincontent">
                ...
                <html:form action="/scpa" method="post" onsubmit="return ValidateContactForm();" >
                    ...
                    <table align="center">
                        <tr>
                            <th>Enter Your Old Password Here:</th>
                            <td></td>
                            <th> <input type="password" name="op" 
                                        required 
                                        value="Enter Old Password Here"  
                                        autoComplete="off"
                                        onblur="onBlur(this)" 
                        ...
                        <tr>
                            <th>Enter Your New Password Here:</th>
                            <td></td>
                            <th> <input type="password" name="np" 
                                        required 
                                        value="Enter New Password Here"  
                                        autoComplete="off"
                                        onblur="onBlur(this)" 
                        ...
                        <tr>
                            <th>Re-Enter Your New Password Here:</th>
                            <td></td>
                            <th> <input type="password" name="rnp" 
                                        required 
                                        value="Re-Enter New Password Here"  
                                        autoComplete="off"
                                        onblur="onBlur(this)" 
