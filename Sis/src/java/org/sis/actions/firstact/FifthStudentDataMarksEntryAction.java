...
public class FifthStudentDataMarksEntryAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        String sid = null, mcn = null, mcd = null, mcg = null, mpe = null, mwt = null, mli = null, mwtlab = null, mlilab = null;
        if (a > 0) {
            ...
            try {
                for (int i = 1; i < a; i++) {
                    ...
                    std.updateMarks(mcn, mcd, mwt, mli, mcg, mpe, mwtlab, mlilab, sid);
                    sid = null;
                    mcn = null;
                    mcd = null;
                    mcg = null;
