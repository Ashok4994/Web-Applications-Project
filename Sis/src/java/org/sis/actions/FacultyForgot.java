 ...
 * @author PEDDI'S
 */
public class FacultyForgot extends DispatchAction {
    ...
    public ActionForward enroll(ActionMapping mapping, ActionForm form,
        ...
        b = fed.forgot(t, temail);
        if (b) {
            bb = fed.newlogp(t, temail, pswd);
            if (bb) {
                ...
                err = "You Are Not Registered! or Your Registered MailId is Invalid";
                request.setAttribute("err", err);
            }
        } else {
            err = "You Are Not Registered! or Your Registered MailId is Invalid";
