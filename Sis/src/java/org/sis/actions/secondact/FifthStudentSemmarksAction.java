...
public class FifthStudentSemmarksAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        String sid = null, scn = null, scd = null, scg = null, spe = null, swt = null, sli = null, swtlab = null, slilab = null, scompviva1 = null;
        if (a > 0) {
            ...
            try {
                for (int i = 1; i < a; i++) {
                    ...
                    std.updatesemMarks(scn, scd, swt, sli, scg, spe,swtlab,slilab,scompviva1, sid);
                    sid = null;
                    scn = null;
                    scd = null;
                    scg = null;
