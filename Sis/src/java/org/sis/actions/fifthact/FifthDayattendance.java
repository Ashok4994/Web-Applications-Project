 ...
 */
package org.sis.actions.fifthact;
...
import org.sis.dao.fifthdao.Dayattendancedao;
    ...
    public ActionForward saveCN(ActionMapping mapping, ActionForm form,
        ...
        try {
            if (g == "ok") {
                ...
                String er = "Please give attendace for all students in DAA!";
    ...
    public ActionForward saveCD(ActionMapping mapping, ActionForm form,
        ...
        try {
            if (g == "ok") {
                ...
                String er = "Please give attendace for all students in ATFL!";
                request.setAttribute("error", er);
                Dayattendancedao da = new Dayattendancedao();
                ArrayList al = da.studentUtils();
                request.setAttribute("list", al);
    ...
    public ActionForward saveWT(ActionMapping mapping, ActionForm form,
        ...
        try {
            if (g == "ok") {
                ...
                String er = "Please give attendace for all students in OOAD!";
                request.setAttribute("error", er);
                Dayattendancedao da = new Dayattendancedao();
                ArrayList al = da.studentUtils();
                request.setAttribute("list", al);
    ...
    public ActionForward saveLI(ActionMapping mapping, ActionForm form,
        ...
        try {
            if (g == "ok") {
                ...
                String er = "Please give attendace for all students in PPL!";
                request.setAttribute("error", er);
                Dayattendancedao da = new Dayattendancedao();
                ArrayList al = da.studentUtils();
                request.setAttribute("list", al);
    ...
    public ActionForward saveCG(ActionMapping mapping, ActionForm form,
        ...
        try {
            if (g == "ok") {
                ...
                String er = "Please give attendace for all students in STM!";
                request.setAttribute("error", er);
                Dayattendancedao da = new Dayattendancedao();
                ArrayList al = da.studentUtils();
                request.setAttribute("list", al);
    ...
    public ActionForward savePE(ActionMapping mapping, ActionForm form,
        ...
        try {
            if (g == "ok") {
                ...
                String er = "Please give attendace for all students in OOADLAB!";
                request.setAttribute("error", er);
                Dayattendancedao da = new Dayattendancedao();
                ArrayList al = da.studentUtils();
                request.setAttribute("list", al);
    ...
    public ActionForward saveWTLAB(ActionMapping mapping, ActionForm form,
        ...
        try {
            if (g == "ok") {
                ...
                String er = "Please give attendace for all students in MPILAB!";
                request.setAttribute("error", er);
                Dayattendancedao da = new Dayattendancedao();
                ArrayList al = da.studentUtils();
                request.setAttribute("list", al);
    ...
    public ActionForward saveLILAB(ActionMapping mapping, ActionForm form,
        ...
        try {
            if (g == "ok") {
                ...
                String er = "Please give attendace for all students in SEMINAR2!";
                request.setAttribute("error", er);
                Dayattendancedao da = new Dayattendancedao();
                ArrayList al = da.studentUtils();
                request.setAttribute("list", al);
