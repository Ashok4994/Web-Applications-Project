...
import org.sis.dao.eighthdao.StdmarksEntryAction;

/**
 *
 * @author PEDDI'S
 */
public class FifthStudentDataEntryAction extends org.apache.struts.action.Action {
...
//        }
        String s = request.getParameter("sdae");
        int a = s != null ? Integer.parseInt(s) : 0;
        String sid = null, acn = null, acd = null, acg = null, ape = null, awt = null, ali = null, awtlab = null, alilab = null;
        if (a > 0) {
