...
import org.sis.dao.seventhdao.Dayattendancedao;
...
public class FifthDayattendance extends DispatchAction {
    ...
    public ActionForward unspecified(ActionMapping mapping, ActionForm form,
        ...
        request.setAttribute("stcompviva1", stcompviva1);
         request.setAttribute("stcompviva1", stdtp);
    ...
    public ActionForward saveCN(ActionMapping mapping, ActionForm form,
        ...
        try {
            if (g == "ok") {
                ...
                String er = "Please give attendace for all students in is!";
    ...
    public ActionForward saveCD(ActionMapping mapping, ActionForm form,
        ...
        try {
            if (g == "ok") {
                ...
                String er = "Please give attendace for all students in dmdw!";
                request.setAttribute("error", er);
                Dayattendancedao da = new Dayattendancedao();
                ArrayList al = da.studentUtils();
                request.setAttribute("list", al);
    ...
    public ActionForward saveWT(ActionMapping mapping, ActionForm form,
        ...
        try {
            if (g == "ok") {
                ...
                String er = "Please give attendace for all students in mc!";
                request.setAttribute("error", er);
                Dayattendancedao da = new Dayattendancedao();
                ArrayList al = da.studentUtils();
                request.setAttribute("list", al);
    ...
    public ActionForward saveLI(ActionMapping mapping, ActionForm form,
        ...
        try {
            if (g == "ok") {
                ...
                String er = "Please give attendace for all students in spm!";
                request.setAttribute("error", er);
                Dayattendancedao da = new Dayattendancedao();
                ArrayList al = da.studentUtils();
                request.setAttribute("list", al);
    ...
    public ActionForward saveCG(ActionMapping mapping, ActionForm form,
        ...
        try {
            if (g == "ok") {
                ...
                String er = "Please give attendace for all students in aca!";
                request.setAttribute("error", er);
                Dayattendancedao da = new Dayattendancedao();
                ArrayList al = da.studentUtils();
                request.setAttribute("list", al);
    ...
    public ActionForward savePE(ActionMapping mapping, ActionForm form,
        ...
        try {
            if (g == "ok") {
                ...
                String er = "Please give attendace for all students in ai!";
                request.setAttribute("error", er);
                Dayattendancedao da = new Dayattendancedao();
                ArrayList al = da.studentUtils();
                request.setAttribute("list", al);
    ...
    public ActionForward saveWTLAB(ActionMapping mapping, ActionForm form,
        ...
        try {
            if (g == "ok") {
                ...
                String er = "Please give attendace for all students in mclab!";
                request.setAttribute("error", er);
                Dayattendancedao da = new Dayattendancedao();
                ArrayList al = da.studentUtils();
                request.setAttribute("list", al);
    ...
    public ActionForward saveLILAB(ActionMapping mapping, ActionForm form,
        ...
        try {
            if (g == "ok") {
                ...
                String er = "Please give attendace for all students in stmlab!";
                request.setAttribute("error", er);
                Dayattendancedao da = new Dayattendancedao();
                ArrayList al = da.studentUtils();
                request.setAttribute("list", al);
    ...
    public ActionForward saveCVIVA(ActionMapping mapping, ActionForm form,
        ...
        try {
            if (g == "ok") {
                ...
                String er = "Please give attendace for all students in internship!";
                request.setAttribute("error", er);
                Dayattendancedao da = new Dayattendancedao();
                ArrayList al = da.studentUtils();
                request.setAttribute("list", al);
  ...
  public ActionForward saveDTP(ActionMapping mapping, ActionForm form,
            HttpServletRequest request, HttpServletResponse response)
            throws Exception {
        String s = request.getParameter("sdsme");
        int a = s != null ? Integer.parseInt(s) : 0;
        ...
        String g = null;
        for (int i = 1; i < a; i++) {
            dcn = request.getParameter("dtp" + i);
            if (dcn == null) {
                g = "no";
            } else {
                g = "ok";
        ...
        try {
            if (g == "ok") {
                ...
                String er = "for subject termpaper!";
                request.setAttribute("status", er);
                Dayattendancedao da = new Dayattendancedao();
                ArrayList al = da.studentUtils();
                request.setAttribute("list", al);
                ...
                String er = "Please give attendace for all students in mprj2!";
                request.setAttribute("error", er);
                Dayattendancedao da = new Dayattendancedao();
                ArrayList al = da.studentUtils();
                request.setAttribute("list", al);
