...
public class Dayattendancedao {
    ...
    public void updateCN(String dcn, String sid) {
        ...
        PreparedStatement pstmt;
        try {
            pstmt = cp.prepareStatement(" update second set  dcn=? where sid=? ");
    ...
    public void updateCD(String dcn, String sid) {
        ...
        PreparedStatement pstmt;
        try {
            pstmt = cp.prepareStatement(" update second set dcd=? where sid=? ");
            pstmt.setString(1, dcn);
            pstmt.setString(2, sid);
            pstmt.executeUpdate();
            if (pstmt != null) {
    ...
    public void updateWT(String dcn, String sid) {
        ...
        PreparedStatement pstmt;
        try {
            pstmt = cp.prepareStatement(" update second set dwt=? where sid=? ");
            pstmt.setString(1, dcn);
            pstmt.setString(2, sid);
            pstmt.executeUpdate();
            if (pstmt != null) {
    ...
    public void updateLI(String dcn, String sid) {
        ...
        PreparedStatement pstmt;
        try {
            pstmt = cp.prepareStatement(" update second set dli=? where sid=? ");
            pstmt.setString(1, dcn);
            pstmt.setString(2, sid);
            pstmt.executeUpdate();
            if (pstmt != null) {
    ...
    public void updateCG(String dcn, String sid) {
        ...
        PreparedStatement pstmt;
        try {
            pstmt = cp.prepareStatement(" update second set dcg=? where sid=? ");
            pstmt.setString(1, dcn);
            pstmt.setString(2, sid);
            pstmt.executeUpdate();
            if (pstmt != null) {
    ...
    public void updatePE(String dcn, String sid) {
        ...
        PreparedStatement pstmt;
        try {
            pstmt = cp.prepareStatement(" update second set dpe=? where sid=? ");
            pstmt.setString(1, dcn);
            pstmt.setString(2, sid);
            pstmt.executeUpdate();
            if (pstmt != null) {
    ...
    public void updateWTLAB(String dcn, String sid) {
        ...
        PreparedStatement pstmt;
        try {
            pstmt = cp.prepareStatement(" update second set dwtlab=? where sid=? ");
            pstmt.setString(1, dcn);
            pstmt.setString(2, sid);
            pstmt.executeUpdate();
            if (pstmt != null) {
    ...
    public void updateLILAB(String dcn, String sid) {
        ...
        PreparedStatement pstmt;
        try {
            pstmt = cp.prepareStatement(" update second set dlilab=? where sid=? ");
            pstmt.setString(1, dcn);
            pstmt.setString(2, sid);
            pstmt.executeUpdate();
            if (pstmt != null) {
    ...
    public void updateCVIVA(String dcn, String sid) {
        ...
        PreparedStatement pstmt;
        try {
            pstmt = cp.prepareStatement(" update second set dcompviva1=? where sid=? ");
            pstmt.setString(1, dcn);
            pstmt.setString(2, sid);
            pstmt.executeUpdate();
            if (pstmt != null) {
    ...
    private void updatefinal(int nwdcn, int nadcn, int nwdcd, int nadcd, int nwdwt, int nadwt, int nwdli, int nadli, int nwdcg, int nadcg, int nwdpe, int nadpe, int nwdwtlab, int nadwtlab, int nwdlilab, int nadlilab, int nwdcompviva1, int nadcompviva1, String sid) {
        ...
        PreparedStatement pstmt;
        try {
            pstmt = cp.prepareStatement("update second set nwdcn=?, nadcn=?, Acn=?,nwdcd=?,\n"
                    + "      nadcd=?,\n"
                    + "      Acd=?,\n"
                    + "      nwdwt=?,\n"
                    + "      nadwt=?,\n"
