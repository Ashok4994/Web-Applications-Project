...
public class Dayattendancedao {
    ...
    public void updateCN(String dcn, String sid) {
        ...
        PreparedStatement pstmt;
        try {
            pstmt = cp.prepareStatement(" update seventh set  dcn=? where sid=? ");
    ...
    public void updateCD(String dcn, String sid) {
        ...
        PreparedStatement pstmt;
        try {
            pstmt = cp.prepareStatement(" update seventh set dcd=? where sid=? ");
            pstmt.setString(1, dcn);
            pstmt.setString(2, sid);
            pstmt.executeUpdate();
            if (pstmt != null) {
    ...
    public void updateWT(String dcn, String sid) {
        ...
        PreparedStatement pstmt;
        try {
            pstmt = cp.prepareStatement(" update seventh set dwt=? where sid=? ");
            pstmt.setString(1, dcn);
            pstmt.setString(2, sid);
            pstmt.executeUpdate();
            if (pstmt != null) {
    ...
    public void updateLI(String dcn, String sid) {
        ...
        PreparedStatement pstmt;
        try {
            pstmt = cp.prepareStatement(" update seventh set dli=? where sid=? ");
            pstmt.setString(1, dcn);
            pstmt.setString(2, sid);
            pstmt.executeUpdate();
            if (pstmt != null) {
    ...
    public void updateCG(String dcn, String sid) {
        ...
        PreparedStatement pstmt;
        try {
            pstmt = cp.prepareStatement(" update seventh set dcg=? where sid=? ");
            pstmt.setString(1, dcn);
            pstmt.setString(2, sid);
            pstmt.executeUpdate();
            if (pstmt != null) {
    ...
    public void updatePE(String dcn, String sid) {
        ...
        PreparedStatement pstmt;
        try {
            pstmt = cp.prepareStatement(" update seventh set dpe=? where sid=? ");
            pstmt.setString(1, dcn);
            pstmt.setString(2, sid);
            pstmt.executeUpdate();
            if (pstmt != null) {
    ...
    public void updateWTLAB(String dcn, String sid) {
        ...
        PreparedStatement pstmt;
        try {
            pstmt = cp.prepareStatement(" update seventh set dwtlab=? where sid=? ");
            pstmt.setString(1, dcn);
            pstmt.setString(2, sid);
            pstmt.executeUpdate();
            if (pstmt != null) {
    ...
    public void updateLILAB(String dcn, String sid) {
        ...
        PreparedStatement pstmt;
        try {
            pstmt = cp.prepareStatement(" update seventh set dlilab=? where sid=? ");
            pstmt.setString(1, dcn);
            pstmt.setString(2, sid);
            pstmt.executeUpdate();
            if (pstmt != null) {
    ...
    public void updateCVIVA(String dcn, String sid) {
        ...
        PreparedStatement pstmt;
        try {
            pstmt = cp.prepareStatement(" update seventh set dcompviva1=? where sid=? ");
            pstmt.setString(1, dcn);
            pstmt.setString(2, sid);
            pstmt.executeUpdate();
            if (pstmt != null) {
    ...
    public void updateDTP(String dcn, String sid) {
        Databaseconn db = new Databaseconn();
        Connection cp = db.getConnection();
        db = null;
        PreparedStatement pstmt;
        try {
            pstmt = cp.prepareStatement(" update seventh set dtp=? where sid=? ");
            pstmt.setString(1, dcn);
            pstmt.setString(2, sid);
            pstmt.executeUpdate();
            if (pstmt != null) {
    ...
    public void studentU() {
        String sid = null, dcn = null, dcd = null, dcg = null, dpe = null, dwt = null, dli = null, dwtlab = null, dlilab = null, dcompviva1 = null, dtp = null;
        Databaseconn db = new Databaseconn();
        Connection cp = db.getConnection();
        db = null;
        PreparedStatement pstmt;
        try {
            ...
            while (rs.next()) {
                ...
                int nwddtp = rs.getInt("nwddtp");
                int naddtp = rs.getInt("naddtp");
                if (dcn.equals("p")) {
                    nwdcn = nwdcn + 1;
                    nadcn = nadcn + 1;
                } else {
                ...
                updatefinal(nwdcn, nadcn, nwdcd, nadcd, nwdwt, nadwt, nwdli, nadli, nwdcg, nadcg, nwdpe, nadpe, nwdwtlab, nadwtlab, nwdlilab, nadlilab, nwdcompviva1, nadcompviva1,nwddtp, naddtp, sid);
            }
            if (pstmt != null) {
                pstmt.close();
            }
    ...
    private void updatefinal(int nwdcn, int nadcn, int nwdcd, int nadcd, int nwdwt, int nadwt, int nwdli, int nadli, int nwdcg, int nadcg, int nwdpe, int nadpe, int nwdwtlab, int nadwtlab, int nwdlilab, int nadlilab, int nwdcompviva1, int nadcompviva1,int nwddtp, int naddtp, String sid) {
        float acn = nadcn;
        float wcn = nwdcn;
        float ccn = 0;
        ccn = (acn) / (wcn);
        ...
        PreparedStatement pstmt;
        try {
            pstmt = cp.prepareStatement("update seventh set nwdcn=?, nadcn=?, Acn=?,nwdcd=?,\n"
                    + "      nadcd=?,\n"
                    + "      Acd=?,\n"
                    + "      nwdwt=?,\n"
                    + "      nadwt=?,\n"
                    ...
                    + "      Alilab=?,\n"
                    + "      nwdcompviva1=?,\n"
                    + "      nadcompviva1=?, Acompviva1=?,nwddtp=?,naddtp=?,Adtp=?  where sid=? ");
            ...
            pstmt.setDouble(28, wdtp);
            pstmt.setDouble(29, adtp);
            pstmt.setDouble(30, dtp);
            pstmt.setString(31, sid);
            pstmt.executeUpdate();
