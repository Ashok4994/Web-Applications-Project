...
public class StdmarksEntryAction {
    ...
    public ArrayList studentUtils() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                float fa = pe + cn + cg + cd + wt + li + wtlab + lilab ;
                Float a = (fa / 800) * 100;
                mp.put("a", a);
                s.studentU(a,sid);
                list.add(mp);
    ...
    public int updateAttendance(String acn, String acd, String awt, String ali, String acg, String ape, String awtlab, String alilab, String sid) {
        int k = 0;
        Databaseconn db = new Databaseconn();
        Connection cp = db.getConnection();
        db = null;
        PreparedStatement pstmt;
        try {
            pstmt = cp.prepareStatement(" update first set acn=?,acd=?,awt=?,ali=?,acg=?,ape=?,awtlab=?,alilab=? where sid=? ");
    ...
    public int updateMarks(String acn, String acd, String awt, String ali, String acg, String ape, String awtlab, String alilab,  String sid) {
        int k = 0;
        Databaseconn db = new Databaseconn();
        Connection cp = db.getConnection();
        db = null;
        PreparedStatement pstmt;
        try {
            pstmt = cp.prepareStatement(" update first set mcn=?,mcd=?,mwt=?,mli=?,mcg=?,mpe=?,mwtlab=?,mlilab=? where sid=? ");
            pstmt.setString(1, acn);
            pstmt.setString(2, acd);
            pstmt.setString(3, awt);
            pstmt.setString(4, ali);
    ...
    public int updatesemMarks(String scn, String scd, String swt, String sli, String scg, String spe, String swtlab, String slilab,  String sid) {
        int j = 0;
        Databaseconn db = new Databaseconn();
        Connection cp = db.getConnection();
        db = null;
        PreparedStatement pstmt;
        try {
            pstmt = cp.prepareStatement(" update first set scn=?,scd=?,swt=?,sli=?,scg=?,spe=?,swtlab=?,slilab=? where sid=? ");
    ...
    public void studentU(float a,String sid) {
        ...
        PreparedStatement pstmt;
        try {
            pstmt = cp.prepareStatement(" update first set Af=? where sid=? ");
            pstmt.setFloat(1, j);
