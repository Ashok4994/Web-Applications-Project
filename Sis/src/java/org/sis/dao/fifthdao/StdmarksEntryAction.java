...
public class StdmarksEntryAction {
    ...
    public ArrayList studentUtils() {
        ...
        try {
            pstmt = cp.prepareStatement("select * from fifth");
    ...
    public int updateAttendance(String acn, String acd, String awt, String ali, String acg, String ape, String awtlab, String alilab, String acompviva1, String sid) {
        ...
        PreparedStatement pstmt;
        try {
            pstmt = cp.prepareStatement(" update fifth set acn=?,acd=?,awt=?,ali=?,acg=?,ape=?,awtlab=?,alilab=?,acompviva1=? where sid=? ");
    ...
    public int updateMarks(String acn, String acd, String awt, String ali, String acg, String ape, String awtlab, String alilab, String acompviva1, String sid) {
        ...
        PreparedStatement pstmt;
        try {
            pstmt = cp.prepareStatement(" update fifth set mcn=?,mcd=?,mwt=?,mli=?,mcg=?,mpe=?,mwtlab=?,mlilab=?,mcompviva1=? where sid=? ");
            pstmt.setString(1, acn);
            pstmt.setString(2, acd);
            pstmt.setString(3, awt);
            pstmt.setString(4, ali);
    ...
    public int updatesemMarks(String scn, String scd, String swt, String sli, String scg, String spe, String swtlab, String slilab, String scompviva1, String sid) {
        ...
        PreparedStatement pstmt;
        try {
            pstmt = cp.prepareStatement(" update fifth set scn=?,scd=?,swt=?,sli=?,scg=?,spe=?,swtlab=?,slilab=?,scompviva1=? where sid=? ");
    ...
    public void studentU(float a,String sid) {
        ...
        PreparedStatement pstmt;
        try {
            pstmt = cp.prepareStatement(" update fifth set Af=? where sid=? ");
            pstmt.setFloat(1, j);
