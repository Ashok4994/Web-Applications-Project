    ...
    <body>
            ...
            <nav>
                <div id="menubar">
                    <ul id="nav">
                        ...
                        <li class="current"><a href="addmentor.pvk">Add New Mentor</a></li>
        ...
        <div id="content">
            <div id="scrollContent">
                <html:form action="addmenact.pvk" method="post">
                    ...
                    <center>  <table  border="1" >
                        <tr align="center" bgcolor="green" style="color:white;">
                            <th>Department ID</th>
                            <td ><input autocomplete="off" size="3" type="number"  name="did" required /></td>
                        </tr>
                        <tr>
                            <th>Department Name</th>
                            <td ><input autocomplete="off" size="3" type="text"  name="dname" required /></td>
                        </tr>
                        <tr>
                            <th>Teacher Id</th>  <td ><input autocomplete="off" size="3" type="number"  name="tid" required/></td>
                        </tr> <tr>
                            <th>Teacher Name</th>  <td ><input autocomplete="off" size="3" type="text"  name="tname" required/></td>
                        </tr> <tr> <th>Teacher EmailId</th>  <td ><input autocomplete="off" type="text"  name="temail" required /></td></tr>
                        </table></center>
                    <br> <center><input type="submit" value="Add Mentor" /></center><br><br><br><br><br>
                    </html:form>
