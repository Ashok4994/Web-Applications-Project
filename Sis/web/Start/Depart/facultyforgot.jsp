    ...
    <body>
        ...
        <div id="content">
            <div id="scrollContent">
                <center> <img SRC="<%=contextPath%>/Start/Images/forgot.png" alt="" height="100" width="300" /> <img SRC="<%=contextPath%>/Start/Images/change.png" alt="" height="100" width="300" /></center>
                <div class="entry">
                    <html:form action="/forgotfaculty" method="post" onsubmit="return ValidateContactForm()" >
