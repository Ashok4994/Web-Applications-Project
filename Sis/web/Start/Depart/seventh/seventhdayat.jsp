    ...
    <head>
        ...
        <script language="javascript" type="text/javascript">
            ...
            function saveCVIVA()
            {
             ...
             function saveDTP()
            {
                document.forms[0].m.value = "saveDTP";
                document.forms[0].submit();
            }
        </script>
    </head>
    <body id="wrap" background="<%=contextPath%>/Start/Depart/cse/aftlgnbg.jpg" >
       <%
        ...
        <div class="menu4">
            ...
            <a href="seventhdayat.pvk" class="current"><span>Day Attendance</span></a>
                ...
                <logic:notEmpty name="list">
                    <table align="center" border="1" >
                        <tr align="center" bgcolor="green" style="color:white;">
                            ...
                            <th>Student name</th>
                            <th>Section</th>
                            <th>is<table><tr><td>p</td><td></td><td></td><td>a</td></tr></table></th>
                            <th>dmdw<table><tr><td>p</td><td></td><td></td><td>a</td></tr></table></th>
                            <th>mc<table><tr><td>p</td><td></td><td></td><td>a</td></tr></table></th>
                            <th>spm<table><tr><td>p</td><td></td><td></td><td>a</td></tr></table></th>
                            <th>aca<table><tr><td>p</td><td></td><td></td><td>a</td></tr></table></th>
                            <th>ai<table><tr><td>p</td><td></td><td></td><td>a</td></tr></table></th>
                            <th>mclab<table><tr><td>p</td><td></td><td></td><td>a</td></tr></table></th>
                            <th>stmlab<table><tr><td>p</td><td></td><td></td><td>a</td></tr></table></th>
                            <th>internship<table><tr><td>p</td><td></td><td></td><td>a</td></tr></table></th>
                             <th>termpaper<table><tr><td>p</td><td></td><td></td><td>a</td></tr></table></th>
                        </tr>
                        <logic:iterate name="list" id="user" >
                            <tr>
                                ...
                                <td ><input size="1" type="radio"  name="dcompviva1<%=k%>" value="p" checked="" id="dcompviva1"/>
                                 ...
                                 <td ><input size="1" type="radio"  name="dtp<%=k%>" value="p" checked="" id="dtp"/>
                                    <input size="1" type="radio"  name="dtp<%=k%>" value="a" id="dtp"/></td>
                                    <%k++;%>
                            </tr>
                        </logic:iterate>
                        <tr>
                            ...
                            <td align="center"><font size="0.5" ><logic:notEmpty name="stcn"><%=request.getAttribute("stcompviva1")%></font></logic:notEmpty></td>
                             <td align="center"><font size="0.5" ><logic:notEmpty name="stcn"><%=request.getAttribute("stdtp")%></font></logic:notEmpty></td>
                            </tr>
                            <tr>
                                <td ></td>
                                <td></td>
                                ...
                                <td><input type="button" value="SAVE" onclick="saveDTP();" /></td>
                            </tr>
                        </table>
